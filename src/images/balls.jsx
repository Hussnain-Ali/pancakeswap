...
const Balls = () => {
  return (
    <div>
      <div class="main-div-balls">
        <div class="sub-div-main">
          <div class="div-for-balls">
            <svg
              viewBox="0 0 32 32"
              width="100%"
              height="100%"
            ...
            >
              ...
              <g opacity="0.1" className="g-class">
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
            ...
            <div class="number-div">
              <div
                font-size="42px"
                color="text"
                class="sc-gtsrHT sc-hgIrPW jYDilb eqagDr"
              >
                5
              </div>
            </div>
          ...
          <div class="div-for-balls">
            ...
            <div class="number-div">
              <div
                font-size="42px"
                color="text"
                class="sc-gtsrHT sc-hgIrPW jYDilb gFdYVD"
              >
                7
              </div>
            </div>
          ...
          <div class="div-for-balls">
            ...
            <div class="number-div">
              <div
                font-size="42px"
                color="text"
                class="sc-gtsrHT sc-hgIrPW jYDilb gFdYWi"
              >
                0
              </div>
            </div>
          ...
          <div class="div-for-balls">
            ...
            <div class="number-div">
              <div
                font-size="42px"
                color="text"
                class="sc-gtsrHT sc-hgIrPW jYDilb eqagDz"
              >
                0
              </div>
            </div>
          ...
          <div class="div-for-balls">
            ...
            <div class="number-div">
              <div
                font-size="42px"
                color="text"
                class="sc-gtsrHT sc-hgIrPW jYDilb gFdYVE"
              >
                2
              </div>
            </div>
