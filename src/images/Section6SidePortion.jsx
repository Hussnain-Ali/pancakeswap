...
const Section6SidePortion = () => {
  return (
    <div>
      <div class="sc-jSFjdj sc-gKAaRy kJmatq jENxgx">
        <div width="280px,330px,380px" class="sc-jSFjdj sc-TXRkg gfUrCs ipSJEO">
          <div height="220px" class="sc-jSFjdj sc-gpAxqO bLjoJo cwaxyb">
            <div class="sc-jLDROR lbqFAR">
              <div class="sc-jSFjdj kJmatq"></div>
              <div class="sc-jSFjdj sc-gKAaRy sc-jOvNRn kJmatq jcNvwq kyVWGp">
                <div class="sc-jSFjdj sc-gKAaRy hCNsvx dRVWhO">
                  <svg
                    viewBox="0 0 32 32"
                    color="text"
                  ...
                  >
                    ...
                    <g opacity="0.1" className="g-style6">
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                  ...
                  <div class="sc-epOimh bvFYXK">
                    <div
                      font-size="14px"
                      color="text"
                      class="sc-gtsrHT sc-hgIrPW iOJDfj eqagDy"
                    >
                      9
                    </div>
                  </div>
              ...
              <div color="secondary" class="sc-gtsrHT fguItW">
                A
              </div>
              <svg
                viewBox="0 0 258 46"
              ...
              >
                ...
                >
                  ...
                  <defs>
                    ...
                    >
                      <stop stop-color="#ED4B9E"></stop>
                      <stop offset="0.190071" stop-color="#7B61FF"></stop>
                      <stop offset="0.434873" stop-color="#1FC7D4"></stop>
                      <stop offset="0.638006" stop-color="#31D0AA"></stop>
                      <stop offset="0.841139" stop-color="#FFD800"></stop>
                      <stop offset="1" stop-color="#FEAF2E"></stop>
                    </linearGradient>
...
export default Section6SidePortion
