...
const Section7SidePortion = () => {
  return (
    <div>
      <div className="sc-jSFjdj sc-gKAaRy kJmatq jENxgx">
        <div
          width="280px,330px,380px"
          className="sc-jSFjdj sc-TXRkg gfUrCs ipSJEO"
        >
          <div height="auto" className="sc-jSFjdj sc-gpAxqO hGdlvP cwaxyb">
            <div className="sc-jSFjdj sc-gKAaRy gSuCSO cqgffe">
              <svg
                viewBox="0 0 103 105"
                width="100px"
                height="100px"
            ...
            <div className="sc-jSFjdj sc-gKAaRy kJmatq ViahK">
              ...
              <div
                font-size="12px"
                color="secondary"
                className="sc-gtsrHT lgSuSQ"
              >
                Prize pool allocation
              </div>
            </div>
            <div className="sc-fExJIe bKMQTV">
              <div className="sc-jSFjdj sc-gKAaRy kJmatq togOu">
                <div color="#FFE362" className="sc-jdtaiD cjgEG"></div>
                <div color="textSubtle" className="sc-gtsrHT bppiMQ">
                  Matches first 1
                </div>
              </div>
              <div color="text" className="sc-gtsrHT fXwrKu">
                2%
              </div>
              <div className="sc-jSFjdj sc-gKAaRy kJmatq togOu">
                <div color="#85C54E" className="sc-jdtaiD brrole"></div>
                <div color="textSubtle" className="sc-gtsrHT bppiMQ">
                  Matches first 2
                </div>
              </div>
              ...
              <div className="sc-jSFjdj sc-gKAaRy kJmatq togOu">
                <div color="#028E75" className="sc-jdtaiD jEtGgF"></div>
                <div color="textSubtle" className="sc-gtsrHT bppiMQ">
                  Matches first 3
                </div>
              </div>
              ...
              <div className="sc-jSFjdj sc-gKAaRy kJmatq togOu">
                <div color="#36E8F5" className="sc-jdtaiD byiZmH"></div>
                <div color="textSubtle" className="sc-gtsrHT bppiMQ">
                  Matches first 4
                </div>
              </div>
              ...
              <div className="sc-jSFjdj sc-gKAaRy kJmatq togOu">
                <div color="#A881FC" className="sc-jdtaiD buTfgx"></div>
                <div color="textSubtle" className="sc-gtsrHT bppiMQ">
                  Matches first 5
                </div>
              </div>
              ...
              <div className="sc-jSFjdj sc-gKAaRy kJmatq togOu">
                <div color="#D750B2" className="sc-jdtaiD lnSzMK"></div>
                <div color="textSubtle" className="sc-gtsrHT bppiMQ">
                  Matches all 6
                </div>
              </div>
              ...
              <div className="sc-jSFjdj sc-gKAaRy kJmatq togOu">
                <div color="#BDC2C4" className="sc-jdtaiD eYPFwI"></div>
                <div color="textSubtle" className="sc-gtsrHT bppiMQ">
                  Burn Pool
                </div>
              </div>
...
export default Section7SidePortion
